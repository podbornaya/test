...
function getMarqueeSnippet(c){const sep='&nbsp;•&nbsp;';return `<!-- Tilda custom block: marquee -->\n<style>\n.tp-marquee{overflow:hidden;width:100%;background:${c.bgColor}}.tp-marquee__track{display:flex;width:max-content;white-space:nowrap;animation:tpMarqueeScroll ${c.speed}s linear infinite}.tp-marquee__text{display:inline-flex;align-items:center;padding:12px 6px;font-size:22px;line-height:1.25;font-weight:600;color:${c.textColor};font-family:inherit}@keyframes tpMarqueeScroll{from{transform:translateX(0)}to{transform:translateX(-50%)}}\n</style>\n<div class="tp-marquee"><div class="tp-marquee__track"><span class="tp-marquee__text">${escapeHtml(c.text)}${sep}</span><span class="tp-marquee__text" aria-hidden="true">${escapeHtml(c.text)}${sep}</span></div></div>`;}
